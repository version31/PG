                                ...
                                <div class="card-body card-body pb-0 d-flex justify-content-between align-items-start">
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-transparent dropdown-toggle p-0" type="button"
                                            ...
                                            <svg class="c-icon">
                                                <use
                                                    xlink:href="afra/vendors/@coreui/icons/svg/free.svg#cil-settings"></use>
                                            </svg>
                                        </button>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="btn-toolbar d-none d-md-block" role="toolbar"
                                    ...
                                    <button class="btn btn-primary" type="button">
                                        <svg class="c-icon">
                                            <use
                                                xlink:href="afra/vendors/@coreui/icons/svg/free.svg#cil-cloud-download"></use>
                                        </svg>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header bg-facebook content-center">
                                    <svg class="c-icon c-icon-3xl text-white my-4">
                                        <use xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-facebook-f"></use>
                                    </svg>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card">
                                <div class="card-header bg-twitter content-center">
                                    <svg class="c-icon c-icon-3xl text-white my-4">
                                        <use xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-twitter"></use>
                                    </svg>
                                </div>
                                <div class="card-body row text-center">
                                    <div class="col">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card">
                                <div class="card-header bg-linkedin content-center">
                                    <svg class="c-icon c-icon-3xl text-white my-4">
                                        <use xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-linkedin"></use>
                                    </svg>
                                </div>
                                <div class="card-body row text-center">
                                    <div class="col">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="afra/vendors/@coreui/icons/svg/free.svg#cil-user"></use>
                                                    </svg>
                                                    <div>Male</div>
                                            ...
                                            <div class="progress-group mb-5">
                                                <div class="progress-group-header">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="afra/vendors/@coreui/icons/svg/free.svg#cil-user-female"></use>
                                                    </svg>
                                                    <div>Female</div>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header align-items-end">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-google"></use>
                                                    </svg>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header align-items-end">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-facebook-f"></use>
                                                    </svg>
                                                    <div>Facebook</div>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header align-items-end">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-twitter"></use>
                                                    </svg>
                                                    <div>Twitter</div>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header align-items-end">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-linkedin"></use>
                                                    </svg>
                                                    <div>LinkedIn</div>
                                    ...
                                    <table class="table table-responsive-sm table-hover table-outline mb-0">
                                        ...
                                        <tr>
                                            <th class="text-center">
                                                <svg class="c-icon">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/free.svg#cil-people"></use>
                                                </svg>
                                            </th>
                                            <th>User</th>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="afra/assets/img/avatars/1.jpg"
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/flag.svg#cif-us"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-cc-mastercard"></use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="afra/assets/img/avatars/2.jpg"
                                                                           alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/flag.svg#cif-br"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-cc-visa"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="afra/assets/img/avatars/3.jpg"
                                                                           alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/flag.svg#cif-in"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-cc-stripe"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="afra/assets/img/avatars/4.jpg"
                                                                           alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/flag.svg#cif-fr"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-cc-paypal"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="afra/assets/img/avatars/5.jpg"
                                                                           alt="user@email.com"><span
                                                        class="c-avatar-status bg-success"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/flag.svg#cif-es"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-cc-apple-pay"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="afra/assets/img/avatars/6.jpg"
                                                                           alt="user@email.com"><span
                                                        class="c-avatar-status bg-danger"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/flag.svg#cif-pl"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="afra/vendors/@coreui/icons/svg/brand.svg#cib-cc-amex"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
...
<script src="afra/vendors/@coreui/chartjs/js/coreui-chartjs.bundle.js"></script>
<script src="afra/vendors/@coreui/utils/js/coreui-utils.js"></script>
<script src="afra/js/main.js"></script>
